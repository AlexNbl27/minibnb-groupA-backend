...
describe("ListingService", () => {
  ...
  describe("getAll", () => {
    it("should return listings with default pagination", async () => {
      const mockListings = [{ id: 1, name: "Listing 1", host: { first_name: "John", avatar_url: "avatar.jpg" } }];
      const mockCount = 1;
  ...
  describe("getById", () => {
    it("should return listing if found", async () => {
      const mockListing = { id: 1, name: "Listing 1", host: { first_name: "John", avatar_url: "avatar.jpg" } };
